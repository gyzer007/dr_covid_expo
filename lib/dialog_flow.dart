...
import 'package:drcovid/facts_message.dart';
...
class _FlutterFactsChatBotState extends State<FlutterFactsChatBot> {
  ...
  void agentResponse(query) async {
    ...
    await AuthGoogle(fileJson: "assets/dr-covid-oidxpu-1ecb293f5498.json").build();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Chat with Dr. COVID", style: TextStyle(color: Colors.white),),
